...
export function convertCashnet(reqBody) {
    ...
    for (let i = 1; i <= cnt; i++) {
        ...
        } else if (itemcode === "MA4-INTSHIP") {
            parseIntlShipping(params, items, txShippingInfo, i);
        } else if (itemcode === "MA4-DOMSHIP") {
            parseDomShipping(params, items, txShippingInfo, i);
        } else {
    ...
    return {
        ...
        domesticShippingLineItems: items.domesticShippingLineItems,
        gear: items.gear
    }
}
