...
<p>
  <h4>Registration for the ${eventYear} ${siteName} is a 4-step process:</h4>
  <ol>
    <li>
    ...
    <li>
      Purchase ticket code(s) at <a target="_blank" href="https://commerce.cashnet.com/TheGreatPuzzleHunt2020">https://commerce.cashnet.com/TheGreatPuzzleHunt2020</a>.<br/>
      Ticket code(s) will be sent to your email.
      Deadline: <strong>9:30 AM ${eventDate}</strong>
    </li>
    <li>
    ...
    <li>
      Set-up/join team at <a target="_blank" href="http://greatpuzzlehunt.com/team">${siteURL}/team</a>.<br/>
    </li>
  </ol>
