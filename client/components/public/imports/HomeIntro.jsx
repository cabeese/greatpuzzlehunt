          ...
          <Grid.Row columns={3}>
            <Grid.Column>
              ...
              <Segment padded inverted color='blue' >
                ...
                <p>The 2021 Puzzle Hunt is virtual, so anywhere that has WiFi access, a smartphone or computer, a black and white printer, and materials listed under the FAQs under <a href="/faq" style={{color: "#bad80a"}}>What should I bring?</a></p>
              </Segment>
            </Grid.Column>
            <Grid.Column>
              <Segment padded inverted color='blue' >
