            ...
            <Grid.Column width={16} className='raised'>
              <Container textAlign='left'>
                ...
                <Segment basic size='large' className="no-padding">
                  <p>The Great Puzzle Hunt is a puzzle-solving adventure. Teams of up to 6 people work virtually from anywhere in the world or if in-person, travel on foot to various locations on WWU campus, solving a total of four hour-long puzzles gathering clues along the way to solve one final meta puzzle.</p>
